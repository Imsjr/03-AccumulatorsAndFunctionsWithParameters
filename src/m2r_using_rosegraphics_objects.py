...
#            window = rg.RoseWindow(height, length, name)
#
...
#            Delays the drawings on the window by whatever parameter you put in
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            This is necessary because the window closes automatically after the
#            turtle is done running its code, we want to be able to see the
#            results so we leave it open
#
